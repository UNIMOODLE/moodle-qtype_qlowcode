...
class qtype_qlowcode_edit_form extends question_edit_form {
    ...
    protected function definition_inner($mform) {
        ...
        $workspaces = qtype_qlowcode\external\qlc_get_workspaces::get_workspaces($configurlselected);
        if (!empty($workspaces)) {
        ...
        $applications = qtype_qlowcode\external\qlc_get_applications::get_applications($configurlselected, $workspaceid);
        ...
        $pages = qtype_qlowcode\external\qlc_get_pages::get_pages($configurlselected, $applicationid);
        if (!empty($pages)) {
