...
abstract class qlow_wizard_form extends moodleform {
    /**
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU Public License
 */
abstract class qlow_edit_form extends qlow_wizard_form {
    ...
    protected function definition() {
        ...
        $mform->addElement('text', 'questionurl', get_string('url', 'qtype_qlow'),
        array('size' => 50, 'maxlength' => 255));
