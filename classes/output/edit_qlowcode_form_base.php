...
abstract class qlowcode_wizard_form extends moodleform {
    /**
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU Public License
 */
abstract class qlowcode_edit_form extends qlowcode_wizard_form {
    ...
    protected function definition() {
        ...
        // $mform->addElement('text', 'questionurl', get_string('url', 'qtype_qlowcode'),
        // array('size' => 50, 'maxlength' => 255));
        // $mform->setType('questionurl', PARAM_TEXT);
        // $mform->addRule('questionurl', null, 'required', null, 'client');
